 ...
 * `---------------------------------------- /       /                \      \-----------------------------------------'
 *            | LCtrl|      | LAlt |LOWER | / BkSpc /                  \Space \  |RAISE | RCTR |      |      |
 *            |      |      |      |      |/       /                    \      \ |      |      |      |      |
 *            `-----------------------------------'                      '------''---------------------------'
 */
...
// |----------+----------+----------+----------+-----=----+----------|                            |----------+-----=----+----------+----------+----------+----------|
     _______,   _______,   _______,   _______,   _______,   _______,                                _______,   _______,   _______,    KC_UP,    _______,  KC_QWERTY, \
// |----------+----------+----------+----------+-----=----+----------+----------|      |----------+----------+-----=----+----------+----------+----------+----------|
     KC_LSFT,   _______,   _______,   _______,   _______,   _______,   _______,          _______,   _______,   _______,   KC_LEFT,   KC_DOWN,   KC_RGHT,   _______, \
// '----------+----------+----------+----------+----------+----------+----------|      |----------+----------+----------+----------+----------+----------+----------'
                           _______,   _______,   KC_LALT,  KC_LCTRL,   KC_SPC,           KC_BSPC,   _______,   KC_ENT,    _______,   _______ \
//                       |----------+----------+----------+----------+----------|      |----------+----------+----------+----------+----------|
    ),
    /* numpad
    * ,-----------------------------------------.                                          ,----------------------------------------.
